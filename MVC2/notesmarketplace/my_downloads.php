            ...
            <div class="container">
                ...
                <div class="table-responsive">
                    ...
                    $start_from = ($page-1) * $num_per_page;
                     ...
                     $query = "SELECT d.*, s.Title, s.Category, s.IsPaid, s.SellingPrice FROM downloads AS d JOIN sellernotes AS s ON d.NoteID = s.ID  WHERE d.Downloader = $user_id && d.IsSellerHasAllowedDownload = 1 ";
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item text-center" data-toggle="modal" data-target="#exampleModal1">Add Reviews/Feedback</a>
