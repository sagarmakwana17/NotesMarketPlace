        ...
        <div class="col-lg-5">
            <img src="img/top-logo.png">
             <?php
                    ...
                    if(isset($_POST['login'])){
                       ...
                       $query = "SELECT u.* , r.* FROM users AS u JOIN userroles AS r ON u.RoleID = r.ID  WHERE u.EmailID = '{$email}'";
                       ...
                       <?php
                         ...
                         ?>
                             <script>
                                    location.replace('search_notes.php');
                            </script>
                         <?php
            ...
            <form class="" id="login-form" method="post" action="login.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="password-field" placeholder="Password" value="notyet" name="password">
                    ...
                    <h6><a href="forgot_password.html">forgot password?</a></h6>
                </div>
