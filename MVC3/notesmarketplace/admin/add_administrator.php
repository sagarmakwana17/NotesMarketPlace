...
?>
                  ...
                  <?php
                    ...
                    if(isset($_POST['add'])){
                        ...
                        else if(!preg_match('/[0-9]/', $first_name) && !preg_match('/[0-9]/', $last_name) ){
                        
                            $query = "INSERT INTO users(RoleID,FirstName,LastName,EmailID,Password,IsEmailverified,CreatedDate) VALUES(1,'{$first_name}','{$last_name}','{$email}','$password','1',now())";
