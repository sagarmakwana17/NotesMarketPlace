            ...
            <div class="container">
                <div class="table-title row">
                    <div class="col-6">
                        ...
                        <a class="btn btn-primary" href="add_category.php" role="button" style="" id="admin">ADD CATEGORY</a>
                    </div>
                    <div class="col-6">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $active; ?></td>
                             <td>
                                <a class="" href="add_category.php?edit=<?php echo $id; ?>" >
                                    <div class="dots">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="head">
                                        ...
                                        <div class="title">
                                            <h4><?php echo $name;?></h4>
                                            <h4 style="font-size:16px; margin-top:20px;"> Are you sure you want to remove this category?</h4>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-primary" href="remove_category.php?c_id=<?php echo $id ?>" role="button" style="margin-right:50px; background-color:red; " id="approved">YES</a>
