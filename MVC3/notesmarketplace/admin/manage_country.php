            ...
            <div class="container">
                <div class="table-title row">
                    <div class="col-6">
                        ...
                        <a class="btn btn-primary" href="add_country.php" role="button" style="" id="admin">ADD COUNTRY</a>
                    </div>
                    <div class="col-6">
                         ...
                         if(isset($_GET['page'])){
                            ...
                            $start_from = ($page-1) * $num_per_page;
                             ...
                             if(isset($_POST['submit'])){
                                $search = $_POST['search'];
                                 $query = "SELECT * FROM countries WHERE IsActive = 1 AND Name LIKE '{$search}%' OR CountryCode LIKE '{$search}%' ";
                             }
                            else{
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="head">
                                        ...
                                        <div class="title">
                                            <h4><?php echo $name;?></h4>
                                            <h4 style="font-size:16px; margin-top:20px;"> Are you sure you want to remove this country?</h4>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-primary" href="remove_typephp?c_id=<?php echo $id ?>" role="button" style="margin-right:50px; background-color:red; " id="approved">YES</a>
