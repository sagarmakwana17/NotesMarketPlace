            ...
            <div class="container">
                <div class="table-title row">
                    <div class="col-6">
                        ...
                        <a class="btn btn-primary" href="add_administrator.php"  role="button" style="" id="admin">ADD ADMIMINISTRATOR</a>
                    </div>
                    <div class="col-6">
                ...
                <div class="table-responsive">
                    <table class="progres">
                         ...
                         if(isset($_GET['page'])){
                            ...
                            $start_from = ($page-1) * $num_per_page;
                             ...
                             if(isset($_POST['submit'])){ 
                                $search = $_POST['search'];
                                 $query = "SELECT * FROM users WHERE RoleID = 1 AND IsActive = 1 AND FirstName LIKE '{$search}%'  ";
                             }
                            else{
                            $query = "SELECT * FROM users WHERE RoleID = 1 AND IsActive = 1";
                            }
                        ...
                        if(!$admin){
                          ...
                          $total_records = mysqli_num_rows($admin); 
                                ...
                                <div class="modal-content">
                                    <div class="head">
                                        ...
                                        <div class="title">
                                            ...
                                            <h4 style="font-size:16px; margin-top:20px;"> Are you sure you want to remove this account<br> as admin??</h4>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-primary" href="remove_admin.php?user_id=<?php echo $id ?>" role="button" style="margin-right:50px; background-color:red; " id="approved">YES</a>
                ...
                <nav aria-label="Page navigation example" id="pagination" style="margin-top : 20px;">
                    <ul class="pagination d-flex justify-content-center">
                        <li class="page-item  <?php if($page == 1){ echo 'disabled'; }?>">
                            <a class="page-link" href="manage_administrator.php?page=<?php echo $page-1; ?>" aria-label="Previous">
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link <?php if($page == $i) { echo 'active'; }?>" href="manage_administrator.php?page=<?php echo $i ; ?>"><?php echo $i ;?></a>
                        </li>
                        <?php 
                            }
                        ?>
                        ...
                        <li class="page-item <?php if($page == $total_pages){ echo 'disabled'; }?>">
                            <a class="page-link" href="manage_administrator.php?page=<?php echo $page-1; ?>" aria-label="Next">
                                <span aria-hidden="true">&#62;</span>
                            </a>
                        </li>
                    </ul>
