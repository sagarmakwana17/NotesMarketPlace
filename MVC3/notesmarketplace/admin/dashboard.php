...
<body>
    ...
    $r_query = "SELECT * FROM sellernotes WHERE Status = 'inreview' ";
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item text-center">View More Details</a>
                                        <a class="dropdown-item text-center" href="#">Unpublish</a>
                                    </div>
                                </div>
                            </td>
