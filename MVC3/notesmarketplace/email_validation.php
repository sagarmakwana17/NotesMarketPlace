...
try {
    ...
    $mail->Subject = "Email Verification for your NotesMarketPlace Account";       //subject line of email
    $mail->Body = "<p>Hello Dear,</p><br><p>Thank you for signing in with us, <br> Please click below link to verify<p> <a href='http://localhost/NotesMarketPlace/notesmarketplace/verify.php?vkey=$vkey'> Click Here to verify</a> <br><br><p>Regards</p><br><p>NotesMarketPlace</p>";   //Email body
