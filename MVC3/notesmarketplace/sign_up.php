            ...
            <form class="col-md-5" id="login-form" action="" method="post">
                <div class="container">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div style="margin-left: 0px !important; text-align:left !important">
                                <label for="exampleInputEmail1">First Name<span style="margin-left: 0px !important; text-align:left !important; color:red"> *</span></label>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div style="margin-left: 0px !important; text-align:left !important">
                                <label for="exampleInputEmail1">Last Name<span style="margin-left: 0px !important; text-align:left !important; color:red"> *</span></label>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div style="margin-left: 0px !important; text-align:left !important">
                                <label for="exampleInputEmail1">Email<span style="margin-left: 0px !important; text-align:left !important; color:red"> *</span></label>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div style="margin-left: 0px !important; text-align:left !important">
                                <label for="exampleInputEmail1">Password<span style="margin-left: 0px !important; text-align:left !important; color:red"> *</span></label>
                            </div>
                            <input type="password" class="form-control" id="password-field" placeholder="Enter your password" value="" name="password1" required>
                             <?php
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div style="margin-left: 0px !important; text-align:left !important">
                                <label for="exampleInputEmail1">Confirm Password<span style="margin-left: 0px !important; text-align:left !important; color:red"> *</span></label>
                            </div>
                            <input type="password" class="form-control" id="password-field2" placeholder="Re-Enter your password" value="" name="password2" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
