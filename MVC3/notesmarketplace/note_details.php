        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" id="left-side">
                    ...
                    <img src="<?php if(!empty($note_pic)){echo $note_pic ;}else {echo 'img/Search/1.jpg'; }?>" alt="" class="img-fluid le">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="" class="btn btn-primary" data-dismiss="modal" id="reg" href="sign_up.php">REGISTER</button>
                                       
                                        <button type="" class="btn btn-primary" id="publish" name="confirm_publish" href ="login.php" >LOGIN</button>
                                    </div>
                                </div>
                            </div>
                        </div>
