...
if(!empty($_GET['note_location'])){
    ...
    $n_id = $_GET['note_id'];
     ...
     $query = "INSERT INTO downloads(NoteID,Seller,Downloader,IsSellerHasAllowedDownload,IsAttachmentDownloaded,AttachmentDownloadedDate,IsPaid,NoteTitle,NoteCategory,CreatedDate) VALUES('{$note_id}','$seller_id','{$user_id}','1','1',now(),'0','{$note_title}','{$note_cat}',now())";
